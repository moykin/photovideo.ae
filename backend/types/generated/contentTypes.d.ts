...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['news', 'tips', 'featured', 'interview', 'guide', 'inspiration']
    > &
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Booking requests between clients and photographers/videographers';
    displayName: 'Booking';
    pluralName: 'bookings';
  ...
  attributes: {
    agreedPrice: Schema.Attribute.Decimal;
    cancellationReason: Schema.Attribute.Text;
    city: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Dubai'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['AED', 'USD']> &
    ...
    provider: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    providerNotes: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFeedPostFeedPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Social feed posts - photographers share their work';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['work', 'behind_scenes', 'tip', 'announcement', 'travel']
    > &
...
export interface ApiPortfolioPortfolio extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portfolio items for photographers and videographers';
  ...
  attributes: {
    author: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    cameraGear: Schema.Attribute.String;
    category: Schema.Attribute.Enumeration<
      [
        'wedding',
        'portrait',
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client reviews for completed bookings';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    bookingsAsClient: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
    >;
    bookingsAsProvider: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
    >;
    city: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Dubai'>;
    completedBookings: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    portfolios: Schema.Attribute.Relation<
      ...
      'api::portfolio.portfolio'
    >;
    pricePerEvent: Schema.Attribute.Decimal;
    ...
    userType: Schema.Attribute.Enumeration<
      ['photographer', 'videographer', 'both', 'client']
    > &
